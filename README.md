...
`ornament_demo` 不在任务栏显示，会常驻托盘；右键托盘图标可以打开参数面板、锁定/解锁拖动或退出。黑洞会小范围自动移动；未锁定时可以拖动事件视界，锁定后点击会穿透到后面的窗口。参数面板支持连续调整视界大小、视界质量、爱因斯坦环范围、吸积盘开关、吸积盘强度、颜色、倾角和范围；吸积盘勾选后立即出现，半径会随黑洞增大而扩张。
